    ...
    const onGoogleSignIn = async (e) => {
        ...
        if (!isSigningIn) {
            ...
            try {
                ...
                setErrorMessage('Google login unsuccesful.');
                setIsSigningIn(false);
            }
        }
    };
    ...
    return (
        <div className=" min-h-screen flex items-center justify-center">
            ...
            <main className="w-full h-screen flex self-center place-content-center place-items-center">
                <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl bg-white/70" style={{ marginTop: '65px'}}>
                    ...
                    >
                        ...
                        <button
                            ...
                            className={`w-full px-4 py-2 text-gray-100 font-medium rounded-lg ${isSigningIn ? 'bg-gray-300 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700 hover:shadow-xl transition duration-300'}`}
                        >
